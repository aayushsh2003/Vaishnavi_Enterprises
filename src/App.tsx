                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      ...
                      We cater to businesses, educational institutions, and individual customers with high-quality products and 
                      exceptional service.
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      ...
                      <li><Link to="/shipping-policy" className="text-gray-600 hover:text-indigo-600">Shipping Policy</Link></li>
                      <li><Link to="/return-policy" className="text-gray-600 hover:text-indigo-600">Return Policy</Link></li>
                    </ul>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold mb-4">Contact Info</h3>
                    <p className="text-gray-600 mb-2">Email: info@vaishnavienterprises.com</p>
                    <p className="text-gray-600 mb-2">
                      <a href="tel:+919829597230" className="hover:text-indigo-600">
                        Phone: +91-9829597230
                      </a>
                    </p>
                    <p className="text-gray-600 mb-4">
